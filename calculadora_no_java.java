...
public class caixa extends JFrame implements ActionListener
{
	...
	caixa()
	{
		...
		b5 = new JButton ("Limpa");      b5.addActionListener(this);	
		b5.setBackground(Color.black);   b5.addActionListener(this);
		b6 = new JButton ("Pontencia");      b6.addActionListener(this);	
		b6.setBackground(Color.black);   b6.addActionListener(this);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		catch (NumberFormatExeception erro)
		{
			t3.setText("Erro");
			return;
		}
